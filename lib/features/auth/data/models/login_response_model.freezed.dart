...
abstract class _LoginResponseModel implements LoginResponseModel {
  const factory _LoginResponseModel(
      ...
      required final User user}) = _$LoginResponseModelImpl;
...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String school_id, String name});
}
...
class _$UserImpl implements _User {
  const _$UserImpl(
      {required this.id, required this.school_id, required this.name});
...
// ignore: non_constant_identifier_names
  ...
  @override
  String toString() {
    return 'User(id: $id, school_id: $school_id, name: $name)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, school_id, name);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final String school_id,
